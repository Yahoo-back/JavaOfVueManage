...
public class XfOrderSuccess implements Serializable {
    private Integer id;
    ...
    public void setFuionOrderNo(String fuionOrderNo) {
        this.fuionOrderNo = fuionOrderNo;
    }
    ...
    public String toString() {
        ...
        sb.append(", fuionOrderNo=").append(fuionOrderNo);
